...
chroms_GRCh37 = [str(chr_number) for chr_number in range(1,23)]+['X', 'Y', 'MT'] #Names of chromosomes on which calling should be done
...
if config["train_test_split_csv"]=='None':
    ...
    with open(config['tumor_bams_list'],'r') as f:
